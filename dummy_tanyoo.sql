...
--
-- Host: localhost
-- Generation Time: Apr 13, 2013 at 04:20 PM
...
CREATE TABLE IF NOT EXISTS `log` (
  ...
  PRIMARY KEY (`id_log`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='tabel yang menjelaskan penggunaan user terhadap menjawab soa' AUTO_INCREMENT=31 ;
