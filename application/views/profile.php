	<div data-role="content"> 
			...
			<div data-role="fieldcontain" class="ui-hide-label">
				...
				<li>
					...
					<a href="<?php echo base_url()?>index.php/u/<?php echo $profil->username?>" data-rel="popout" data-position-to="window" data-transition="pop"></a> <!--untuk edit profile masukkan link disini-->
					</a>
				</li>
				</ul>
			</div>
