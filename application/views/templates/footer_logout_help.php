	...
	<div data-role="navbar">
		<ul>
			...
			<li><a href="<?php echo base_url()?>index.php/u/help" class="ui-btn-active ui-state-persist" data-rel="popout" data-position-to="window" data-transition="pop" data-ajax="false" data-theme="a" "><img src="<?php echo base_url()?>css/images/help.png" width="15px"></a></li>
