	...
	<div data-role="fieldcontain" class="ui-hide-label">
		...
		<?php 
			if(isset($_POST['bcari'])){	?>
				<?php $i=1 ;?>
				<?php if (count($data_soal) > 0) {
					foreach($data_soal as $t): //menampilkan hasil dari data_soal yang ada dicontroller ke dalam tabel?>   
				...
				<?php	
					...
					echo "<div class='border'><h4 align='center'>Hasil pencarian tidak ditemukan.</h4></div>";
				}
			}
		?>
